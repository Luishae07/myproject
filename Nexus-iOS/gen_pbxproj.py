#!/usr/bin/env python3
"""Generates a real, valid Xcode project.pbxproj for the Nexus iOS app.
...
file_ref_lines.append(
    f'\t\t{app_ref_id} /* Nexus.app */ = {{isa = PBXFileReference; explicitFileType = wrapper.application; includeInIndex = 0; path = Nexus.app; sourceTree = BUILT_PRODUCTS_DIR; }};'
)
...
\t\t{target_id} /* Nexus */ = {{
\t\t\tisa = PBXNativeTarget;
\t\t\tbuildConfigurationList = {build_config_list_target_id} /* Build configuration list for PBXNativeTarget "Nexus" */;
\t\t\tbuildPhases = (
...
\t\t\tname = Nexus;
\t\t\tproductName = Nexus;
\t\t\tproductReference = {app_ref_id} /* Nexus.app */;
...
\t\t\t\t}};
\t\t\t}};
\t\t\tbuildConfigurationList = {build_config_list_project_id} /* Build configuration list for PBXProject "Nexus" */;
...
\t\t\t\tINFOPLIST_KEY_CFBundleDisplayName = Nexus;
\t\t\t\tIPHONEOS_DEPLOYMENT_TARGET = 26.0;
...
\t\t\t\tPRODUCT_BUNDLE_IDENTIFIER = "com.luishae.nexus";
...
\t\t{build_config_list_project_id} /* Build configuration list for PBXProject "Nexus" */ = {{
...
\t\t}};
\t\t{build_config_list_target_id} /* Build configuration list for PBXNativeTarget "Nexus" */ = {{
\t\t\tisa = XCConfigurationList;
\t\t\tbuildConfigurations = (
\t\t\t\t{build_config_debug_target_id} /* Debug */,
\t\t\t\t{build_config_release_target_id} /* Release */,
...
with open("Nexus/Nexus.xcodeproj/project.pbxproj", "w") as f:
    f.write(pbxproj)
