#!/usr/bin/env python3
"""Generates a real, valid Xcode project.pbxproj for the Luisystemd iOS app.
...
file_ref_lines.append(
    f'\t\t{app_ref_id} /* Luisystemd.app */ = {{isa = PBXFileReference; explicitFileType = wrapper.application; includeInIndex = 0; path = Luisystemd.app; sourceTree = BUILT_PRODUCTS_DIR; }};'
)
...
\t\t{target_id} /* Luisystemd */ = {{
\t\t\tisa = PBXNativeTarget;
\t\t\tbuildConfigurationList = {build_config_list_target_id} /* Build configuration list for PBXNativeTarget "Luisystemd" */;
\t\t\tbuildPhases = (
...
\t\t\t);
\t\t\tname = Luisystemd;
\t\t\tproductName = Luisystemd;
\t\t\tproductReference = {app_ref_id} /* Luisystemd.app */;
...
\t\t\t\t}};
\t\t\t}};
\t\t\tbuildConfigurationList = {build_config_list_project_id} /* Build configuration list for PBXProject "Luisystemd" */;
...
\t\t{build_config_list_project_id} /* Build configuration list for PBXProject "Luisystemd" */ = {{
...
\t\t}};
\t\t{build_config_list_target_id} /* Build configuration list for PBXNativeTarget "Luisystemd" */ = {{
\t\t\tisa = XCConfigurationList;
\t\t\tbuildConfigurations = (
\t\t\t\t{build_config_debug_target_id} /* Debug */,
\t\t\t\t{build_config_release_target_id} /* Release */,
...
with open("Luisystemd/Luisystemd.xcodeproj/project.pbxproj", "w") as f:
    f.write(pbxproj)
